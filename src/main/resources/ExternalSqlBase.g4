...
queryNoWith
    : insertInto? queryTerm queryOrganization        EOF                                       #singleInsertQuery
    | fromClause multiInsertQueryBody+    EOF                                              #multiInsertQuery
    ;
